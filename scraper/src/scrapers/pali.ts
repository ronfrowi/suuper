/**
 * Palí (pali.co.cr) scraper — VTEX IO platform.
 * Uses shared vtex.ts helper. Full catalog via VTEX search API (no JS rendering).
 */

import { vtexFetchAll, vtexFetchOne, categoryParam } from './vtex'
import type { RawProduct } from '../types'

const SEARCH_API = 'https://www.pali.co.cr/api/catalog_system/pub/products/search'
